// 1. Geração Solar Total: Um sistema de energia solar registra a geração
...
// 2. Média Semanal: Utilizando a mesma matriz de energia solar, desenvolva
...
// 3. Fim de Semana Produtivo: Escreva uma função sumWeekendGeneration(solarGrid)
